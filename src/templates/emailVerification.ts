                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 16px;">
                            For further assistance as regards this operation, please contact us at
                            <a href="mailto:tnsosanya@student.oauife.edu.ng" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">tnsosanya@student.oauife.edu.ng/a>.
                          </p>
                          <p style="margin: 0 0 16px;">Thanks, <br>MallamTY E-Commerce Support Team</p>
                        </td>
                      </tr>
                      <tr>
